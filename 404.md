...
<head>
  ...
  <script async src="https://arc.io/widget.min.js#sZdT8koM"></script>
...
<body translate="no">
  ...
  <div class="error">
    ...
    <button class="error__button error__button--active" onclick="location.href='kangleimc.tk';">Go Home</button>
  </div>
